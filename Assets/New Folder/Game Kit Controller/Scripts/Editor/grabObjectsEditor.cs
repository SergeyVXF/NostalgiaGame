...
public class grabObjectsEditor : Editor
{
    ...
    SerializedProperty showObjectToGrabNameEnabled;
    SerializedProperty objectToGrabNameText;
    SerializedProperty objectToGrabNamePanel;
    ...
    void OnEnable ()
    {
        ...
        showObjectToGrabNameEnabled = serializedObject.FindProperty ("showObjectToGrabNameEnabled");
        objectToGrabNameText = serializedObject.FindProperty ("objectToGrabNameText");
        objectToGrabNamePanel = serializedObject.FindProperty ("objectToGrabNamePanel");
    ...
    public override void OnInspectorGUI ()
    {
        ...
        if (showAllSettings.boolValue || showUISettings.boolValue) {
            ...
            EditorGUILayout.PropertyField (showObjectToGrabNameEnabled);
            if (showObjectToGrabNameEnabled.boolValue) {
                EditorGUILayout.PropertyField (objectToGrabNameText);
                EditorGUILayout.PropertyField (objectToGrabNamePanel); 
            }
