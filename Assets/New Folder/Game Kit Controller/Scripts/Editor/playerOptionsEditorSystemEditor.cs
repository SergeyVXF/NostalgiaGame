    ...
    void showOptionInfoListElement (SerializedProperty list)
    {
        ...
        if (list.FindPropertyRelative ("optionEnabled").boolValue) {
            ...
            if (list.FindPropertyRelative ("useDropDown").boolValue) {
                ...
                EditorGUILayout.PropertyField (list.FindPropertyRelative ("useDropDownIntegerValueEvent"));
                if (list.FindPropertyRelative ("useDropDownIntegerValueEvent").boolValue) {
                    EditorGUILayout.PropertyField (list.FindPropertyRelative ("dropDownIntegerValueEvent"));
                }
            }
            GUILayout.EndVertical ();
        }
