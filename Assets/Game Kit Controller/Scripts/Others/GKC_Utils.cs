...
public class GKC_Utils : MonoBehaviour
{
    ...
    public static void resetIdleStateOnCloseCombat (GameObject currentPlayer)
    {
        if (currentPlayer == null) {
            return;
        }
        ...
        if (currentPlayerComponentsManager != null) {
            ...
            if (currentCloseCombatSystem != null) {
                currentCloseCombatSystem.resetIdleStateOnCloseCombat ();
            }
        }
    }
    ...
    public static Texture getInventoryObjectIconByName (string inventoryObjectName)
    {
        inventoryListManager mainInventoryListManager = inventoryListManager.Instance;
    ...
    public static GameObject createPrefab (string prefabPath, string prefabName, GameObject prefabToCreate)
    {
        ...
        if (prefabExists) {
            ...
            GKC_Utils.replacePrefabNameBased (newPrefabGameObject, prefab);
            ...
            GKC_Utils.replacePrefabConnectToPrefab (newPrefabGameObject, prefabFilePath);
    ...
    public static menuPause findMainPlayergetPauseManagerOnScene ()
    {
        playerCharactersManager mainPlayerCharactersManager = playerCharactersManager.Instance;
        ...
        if (mainPlayerCharactersManagerLocated) {
            return mainPlayerCharactersManager.getMainPlayerPauseManager ();
        }
    ...
    public static void removeDeviceFromListOnAllPlayersOnSceneWithoutDisablingDevice (GameObject deviceToRemove)
    {
        playerCharactersManager mainPlayerCharactersManager = playerCharactersManager.Instance;
        ...
        if (mainPlayerCharactersManagerLocated) {
            List<GameObject> playerList = mainPlayerCharactersManager.getPlayerList ();
            ...
            if (playerList != null && playerList.Count > 0) {
                for (int i = 0; i < playerList.Count; i++) {
                    ...
                    if (currentUsingDevicesSystem != null) {
                        currentUsingDevicesSystem.removeDeviceFromListExternalCall (deviceToRemove);
                    }
                }
            }
        }
    ...
    public static void updateMainPlayerComponentsOnGameManager (GameObject newPlayerParent)
    {
        ...
        if (mainGameManagerLocated) {
            mainGameManager.updateMainPlayerComponentsOnGameManager (newPlayerParent);
        }
    }
    ...
    public static void increaseStat (Transform characterTransform, string statName, float statAmount)
    {
        playerComponentsManager currentPlayerComponentsManager = characterTransform.GetComponent<playerComponentsManager> ();
        ...
        if (currentPlayerComponentsManager != null) {
            ...
            if (currentPlayerStatsSystem != null) {
                currentPlayerStatsSystem.increasePlayerStat (statName, statAmount);
            }
        }
    }
    ...
    public static bool checkIfObjectIsOnCharacterExtraColliderList (Collider colliderToCheck, GameObject characterToCheck)
    {
        if (characterToCheck != null) {
            playerController currentPlayerController = characterToCheck.GetComponent<playerController> ();

            if (currentPlayerController != null) {
                return checkIfObjectIsOnCharacterExtraColliderList (colliderToCheck, currentPlayerController);
            }
        }
    ...
    public static bool checkIfObjectIsOnCharacterExtraColliderList (Collider colliderToCheck, playerController currentPlayerController)
    {
        return currentPlayerController.isColliderPartOfCharacter (colliderToCheck);
    }
    ...
    public static void updateAllLanguageElementCheckerOnScene ()
    {
        gameLanguageSelector mainGameLanguageSelector = gameLanguageSelector.Instance;
        ...
        if (mainGameLanguageSelectorLocated) {
            mainGameLanguageSelector.updateAllLanguageElementCheckerOnScene ();
        }
    }
    ...
    public static void unpackPrefabObjectByCheckingTransformRoot (GameObject currentObject)
    {
        if (currentObject == null) {
            return;
        }

        Transform currentTransform = currentObject.transform.root;

        if (currentTransform != null) {
            print ("main object root " + currentTransform.name);

            GameObject mainParentGameObject = currentTransform.gameObject;

            if (mainParentGameObject != null) {
                GKC_Utils.unpackPrefabObject (mainParentGameObject);
            }
        }
    }
    ...
    public static void removeTargetFromAICharacter (GameObject objectToRemove, GameObject currentAICharacter)
    {
        if (objectToRemove == null) {
            return;
        }

        playerComponentsManager currentplayerComponentsManager = currentAICharacter.gameObject.GetComponent<playerComponentsManager> ();
        ...
        if (currentplayerComponentsManager != null) {
            ...
            if (currentFindObjectivesSystem != null) {
                ...
                currentFindObjectivesSystem.sendSignalToRemoveCharacterAsTarget (objectToRemove);
            }
        }
    }
    ...
    public static string checkFullArmorClothState (fullArmorClothTemplateData mainFullArmorClothTemplateData,
        List<string> currentPiecesList, bool showDebugPrint)
    {
        if (mainFullArmorClothTemplateData == null) {
            return "";
        }

        string fullArmorClothName = "";

        List<fullArmorClothTemplate> currentFullArmorClothTemplateList = mainFullArmorClothTemplateData.fullArmorClothTemplateList;

        bool checkIfFullArmorCompleteResult = false;

        int fullArmorClothTemplateIndex = -1;

        fullArmorClothTemplate currentFullArmorClothTemplate = null;

        for (int i = 0; i < currentFullArmorClothTemplateList.Count; i++) {
            if (!checkIfFullArmorCompleteResult) {
                ...
                if (currentPiecesList.Count >= fullArmorPiecesListCount) {
                    ...
                    if (currentArmorClothPieceAmountIndex >= fullArmorPiecesListCount) {
                        checkIfFullArmorCompleteResult = true;

                        fullArmorClothTemplateIndex = i;


                        fullArmorClothName = currentFullArmorClothTemplate.Name;
                    }
                }
            }
        }
    ...
    public static string getInteractionObjectsLocalizationManagerLocalizedText (string textContent)
    {
    ...
    public static void renameAsset (GameObject currentObject, string newName)
    {
        if (currentObject == null) {
            return;
        }
    ...
    public static void renameAsset (UnityEngine.Object currentObject, string newName)
    {
        if (currentObject == null) {
            return;
        }
    ...
    public static void replacePrefabNameBased (GameObject newPrefab, UnityEngine.Object currentPrefabObject)
    {
#if UNITY_EDITOR
        PrefabUtility.ReplacePrefab (newPrefab, currentPrefabObject, ReplacePrefabOptions.ReplaceNameBased);
#endif
    }

    public static void replacePrefabConnectToPrefab (GameObject newPrefab, string prefabFilePath)
    {
#if UNITY_EDITOR
        UnityEngine.Object currentPrefabObject = PrefabUtility.CreateEmptyPrefab (prefabFilePath);
