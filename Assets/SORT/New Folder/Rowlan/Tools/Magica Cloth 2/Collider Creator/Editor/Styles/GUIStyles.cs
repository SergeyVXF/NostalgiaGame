...
namespace Rowlan.Tools.MagicaCloth2.ColliderCreator
{
    public class GUIStyles
    {
        ...
        public static Color PreviewAreaForegroundColor = new Color(1f, 1f, 1f, 0.5f);
        public static Color PreviewAreaBackgroundColor = new Color(0.3f, 0.3f, 0.3f, 0.8f);

        public static Color DiagramLineColor = new Color(0.8f, 0.8f, 0.8f, 0.8f);
        public static Color DiagramDotColor = new Color(0.8f, 0.8f, 0.8f, 0.2f);

        public static Color hoverRowColor = new Color(0.9f, 0.9f, 0.9f, 0.2f);
