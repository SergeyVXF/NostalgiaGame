    ...
    public class vTopDownController : vThirdPersonController
    {
        ...
        protected virtual void UpdateCameraToTopDown()
        {
            ...
            if (cam != null)
            {
                ...
                //Create a vector3 (OldTopDownMove) to store the movement direction;
                oldTopDownMove = topDownMove; 
                //if KeepDirection use last direction(oldTopDownMove) else, calc movement Direction from camera.
