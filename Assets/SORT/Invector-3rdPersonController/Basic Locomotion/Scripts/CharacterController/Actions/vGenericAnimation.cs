...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vGenericAnimation : vMonoBehaviour
    {
        ...
        [Tooltip("Enable double press to trigger animation")]
        public bool useDoublePress = false;
        [Tooltip("Time window for double press in seconds")]
        ...
        protected bool waitingForDoublePress;
        ...
        protected virtual void TriggerAnimation()
        {
            ...
            if (actionInput.GetButtonDown() && playConditions)
            {
                ...
                else
                {
                    ...
                    else if (Time.time - lastPressTime <= doublePressTime)
                    {
            ...
            else if (waitingForDoublePress && Time.time - lastPressTime > doublePressTime)
            {
                waitingForDoublePress = false;
            }
        }
