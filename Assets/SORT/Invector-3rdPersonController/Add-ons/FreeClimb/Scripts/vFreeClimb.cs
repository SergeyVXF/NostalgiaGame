...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vFreeClimb : vMonoBehaviour
    {
        ...
        private vGenericAnimation genericAnimation;
        ...
        Vector3 handTargetPosition
        {
            get
            {
                if (handTarget == null)
                {
                    Debug.LogWarning("[vFreeClimb] handTarget не существует! Возвращаем fallback позицию.");
                    return transform.TransformPoint(0, 1.5f, 0);
                }
                ...
                {
                    Debug.LogError($"[vFreeClimb] Ошибка доступа к handTarget: {e.Message}");
                    return transform.TransformPoint(0, 1.5f, 0);
                }
            }
        }
        ...
        protected virtual void Start()
        {
            ...
            genericAnimation = GetComponent<vGenericAnimation>();
        }
        ...
        {            
            ...
            if (genericAnimation != null) genericAnimation.enabled = false;
        }
        ...
        protected virtual void ExitClimb()
        {
            ...
            onExitClimb.Invoke();
            if (genericAnimation != null) genericAnimation.enabled = true;
        }
        ...
        #region Public Methods for External Script Access
        
        /// <summary>
        /// Проверяет, находится ли персонаж в режиме лазания
        /// </summary>
        /// <returns>True если персонаж в режиме лазания</returns>
        public bool IsInClimbMode()
        {
            if (dragInfo != null)
            {
                return dragInfo.inDrag;
            }
            return false;
        }
        
        /// <summary>
        /// Принудительно выходит из режима лазания
        /// </summary>
        public void ForceExitClimb()
        {
            if (IsInClimbMode())
            {
                Debug.Log("[vFreeClimb] Принудительный выход из режима лазания");
                ExitClimb();
            }
        }
