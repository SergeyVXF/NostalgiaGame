...
public class GameMenuUISetup : MonoBehaviour
{
    ...
    void CreateGameMenuUI(GameObject canvas)
    {
        ...
        // Создаем кнопки
        CreateButton(buttonGroup, "Продолжить", null); // Будет настроена в GameMenuManager
        CreateButton(buttonGroup, "Выйти в главное меню", null); // Будет настроена в GameMenuManager
        CreateButton(buttonGroup, "Выйти из игры", null); // Будет настроена в GameMenuManager
