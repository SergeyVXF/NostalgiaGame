...
public class nonEssentialCharacterElementsManagerEditor : Editor
{
    ...
    void showObjectToSelectInfoList (SerializedProperty list)
    {
        ...
        if (list.isExpanded) {
            ...
            for (int i = 0; i < list.arraySize; i++) {
                ...
                if (GUILayout.Button (new GUIContent ("X", "Remove Element From List"))) {
                    list.DeleteArrayElementAtIndex (i);
                }
                if (GUILayout.Button (new GUIContent ("v", "Move Element Down On The List"))) {
                    if (i >= 0) {
                        list.MoveArrayElement (i, i + 1);
                    }
                }
                if (GUILayout.Button (new GUIContent ("^", "Move Element Up On The List"))) {
                    if (i < list.arraySize) {
                        list.MoveArrayElement (i, i - 1);
                    }
                }

                if (GUILayout.Button (new GUIContent ("o", "Select Object On Hierarchy"), buttonStyle)) {
                ...
                if (GUILayout.Button (new GUIContent ("R", "Remove Object"), buttonStyle)) {
                    if (!Application.isPlaying) {
                        manager.removeObjectByIndex (i, true);
                ...
                if (GUILayout.Button (new GUIContent ("E", "Enable Object Active State"), buttonStyle)) {
                    if (!Application.isPlaying) {
                ...
                if (GUILayout.Button (new GUIContent ("D", "Disable Object Active State"), buttonStyle)) {
                    if (!Application.isPlaying) {
    ...
    void showObjectToSelectInfoListElement (SerializedProperty list)
    {
        ...
        EditorGUILayout.PropertyField (list.FindPropertyRelative ("useEventOnDestroyObject"));
        if (list.FindPropertyRelative ("useEventOnDestroyObject").boolValue) {
            EditorGUILayout.PropertyField (list.FindPropertyRelative ("eventOnDestroyObject"));
        }
