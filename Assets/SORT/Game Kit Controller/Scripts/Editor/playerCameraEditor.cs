...
public class playerCameraEditor : Editor
{
    ...
    SerializedProperty smoothReturnSpeed;
    SerializedProperty checkCameraDistanceOnSmoothReturnEnabled;

    SerializedProperty smoothGoSpeed;
    SerializedProperty checkCameraDistanceOnSmoothGoEnabled;

    SerializedProperty useEventsOnLockAtTarget;
    SerializedProperty eventOnLockAtTargetStart;
    SerializedProperty eventOnLockAtTargetEnd;

    SerializedProperty ignoreExternalFovChangesEnabled;
    ...
    void OnEnable ()
    {
        ...
        smoothReturnSpeed = serializedObject.FindProperty ("smoothReturnSpeed");
        checkCameraDistanceOnSmoothReturnEnabled = serializedObject.FindProperty ("checkCameraDistanceOnSmoothReturnEnabled");

        smoothGoSpeed = serializedObject.FindProperty ("smoothGoSpeed");
        checkCameraDistanceOnSmoothGoEnabled = serializedObject.FindProperty ("checkCameraDistanceOnSmoothGoEnabled");

        useEventsOnLockAtTarget = serializedObject.FindProperty ("useEventsOnLockAtTarget");
        eventOnLockAtTargetStart = serializedObject.FindProperty ("eventOnLockAtTargetStart");
        eventOnLockAtTargetEnd = serializedObject.FindProperty ("eventOnLockAtTargetEnd");

        ignoreExternalFovChangesEnabled = serializedObject.FindProperty ("ignoreExternalFovChangesEnabled");
    ...
    public override void OnInspectorGUI ()
    {
        ...
        EditorGUILayout.PropertyField (ignoreExternalFovChangesEnabled); 
        ...
        EditorGUILayout.PropertyField (smoothReturnSpeed);
        EditorGUILayout.PropertyField (checkCameraDistanceOnSmoothReturnEnabled);
        EditorGUILayout.PropertyField (smoothGoSpeed);
        EditorGUILayout.PropertyField (checkCameraDistanceOnSmoothGoEnabled);
        GUILayout.EndVertical ();
        ...
        if (showLookTargetSettings.boolValue) {
            ...
            if (lookAtTargetEnabled.boolValue) {
                ...
                EditorGUILayout.PropertyField (useEventsOnLockAtTarget);
                if (useEventsOnLockAtTarget.boolValue) {

                    EditorGUILayout.PropertyField (eventOnLockAtTargetStart);

                    EditorGUILayout.Space ();

                    EditorGUILayout.PropertyField (eventOnLockAtTargetEnd);
                }
    ...
    void showCameraMouseWheelStatesListElement (SerializedProperty list)
    {
        ...
        EditorGUILayout.PropertyField (list.FindPropertyRelative ("useClampOnCloseDistance"));
        if (list.FindPropertyRelative ("useClampOnCloseDistance").boolValue) {
            EditorGUILayout.PropertyField (list.FindPropertyRelative ("clampOnCloseDistance"));
        }

        EditorGUILayout.Space ();

        EditorGUILayout.PropertyField (list.FindPropertyRelative ("useClampOnFarDistance"));
        if (list.FindPropertyRelative ("useClampOnFarDistance").boolValue) {
            EditorGUILayout.PropertyField (list.FindPropertyRelative ("clampOnFarDistance"));
        }
