...
public class sliceSystem : MonoBehaviour
{
    ...
    {
        if (newcutPositionTransform == null || newCutDirectionTransform == null || 
            newPlaneDefiner1 == null || newPlaneDefiner2 == null || newPlaneDefiner3 == null) {
            return;
        }
    ...
    void setCurrentCutTransformValues ()
    {
        ...
        if (cutPositionTransform == null || cutDirectionTransform == null || 
            planeDefiner1 == null || planeDefiner2 == null || planeDefiner3 == null) {
            return;
        }
