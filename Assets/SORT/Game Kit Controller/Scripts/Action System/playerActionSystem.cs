...
public class playerActionSystem : MonoBehaviour
{
    ...
    {
        if (currentActionInfo.movePlayerOnDirection) {
            mainPlayerController.setIgnoreNewGroundAdherenceActiveState (true);
            ...
            mainPlayerController.setIgnoreNewGroundAdherenceActiveState (false);
        }
    }
    ...
    public void checkCustomActionToActivate (int currentCategoryIndex, int currentActionIndex)
    {
        ...
        if (currentCustomActionStateInfo.useRandomActionSystemList) {
            ...
            bool activateRegularAction = true;
            ...
            if (currentCustomActionStateInfo.useCustomActionIfPlayerIsMoving) {
                if (mainPlayerController.isPlayerMoving (0.4f)) {
                    currentCustomActionStateInfo.customActionIfPlayerIsMoving.activateCustomAction (playerTransform.gameObject);
    ...
    public void pausePlayer ()
    {
        ...
        if (currentActionInfo.ignoreRootMotionDuringAction) {
            mainPlayerController.setIgnoreRootMotionDuringActionState (true);
        }
    ...
    public void resumePlayer ()
    {
        ...
        mainPlayerController.setIgnoreRootMotionDuringActionState (false);
        ...
        if (playerIsAlive) {
            ...
            if (usingAINavmesh) {
                if (currentActionInfo.resumeAIOnActionEnd && !isRagdollCurrentlyActive) {
                    ...
                    if (currentActionInfo.assignPartnerOnActionEnd && mainAINavmesh.isPartnerLocated ()) {
        ...
        if (playerIsAlive) {
            if (isRagdollCurrentlyActive) {
                mainPlayerCamera.setHeadColliderStateOnFBA (false);
            }
        }
    ...
    public class customActionStateInfo
    {
        ...
        [Space]
        [Header ("Action If Player Moving Settings")]
        [Space]

        public bool useCustomActionIfPlayerIsMoving;
        public actionSystem customActionIfPlayerIsMoving;
